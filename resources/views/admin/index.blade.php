                                ...
                                @forelse ($admins as $admin)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5">
                                            <a href="{{ route('admin.show', $admin) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">View</a>
                                            <a href="{{ route('admin.edit', $admin) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
